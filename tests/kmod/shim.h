 ...
 * runtime-resolved by kmod_loader. The .ko is built with 0xDEADBE01..04
 * sentinels that kmod_loader's strategy chain overwrites before calling
 * init_module. See tools/kmod_loader/resolver.{h,c} and
